          ...
          <section className="results" id="resultsSection">
            ...
            {viewMode === "card" ? (
              ...
              const renderCarCol = (item: RecommendationResult | undefined) => {
                if (!item) return <td className="matrix-data-cell text-center">-</td>;
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="matrix-data-cell text-center">
                            {c1.score && <span className={`score-badge ${c1.tier.cls}`}>{c1.score}/100 ({c1.tier.label})</span>}
                          </td>
                          <td className="matrix-data-cell text-center">
                            {c2.score && <span className={`score-badge ${c2.tier.cls}`}>{c2.score}/100 ({c2.tier.label})</span>}
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td className="matrix-data-cell text-center font-bold highlight-tco">
                            {c1.tco && formatBaht(c1.tco.total5yr || c1.calc.total5yr)}
                          </td>
                          <td className="matrix-data-cell text-center font-bold highlight-tco">
                            {c2.tco && formatBaht(c2.tco.total5yr || c2.calc.total5yr)}
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td className="matrix-data-cell text-left">
                            <ul style={{ paddingLeft: "18px", margin: 0 }}>
                              {c1.reasons?.map((rs, idx) => <li key={idx} style={{ marginBottom: "4px" }}>{rs}</li>)}
                            </ul>
                          </td>
                          <td className="matrix-data-cell text-left">
                            <ul style={{ paddingLeft: "18px", margin: 0 }}>
                              {c2.reasons?.map((rs, idx) => <li key={idx} style={{ marginBottom: "4px" }}>{rs}</li>)}
                            </ul>
                          </td>
                        </tr>
                        <tr>
